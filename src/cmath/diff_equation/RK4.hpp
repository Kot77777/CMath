...
[[nodiscard]] typename Callable::VecType RK4_step(const Callable &f, const typename Callable::State &state,
                                                  const double step) {
...
template<typename Callable>
[[nodiscard]] std::vector<typename Callable::State> RK4(const Callable &f, const typename Callable::State &state0,
